export default {
  ...
  'menu.case': '案件管理',
  'menu.case.form': '案件受理',
  'menu.case.ediet': '案件修改',
  'menu.case.advanced': '案件详情',
  'menu.case.list': '案件列表',
  'menu.case.audit': '案件审核',
  'menu.lab': 'DNA实验室',
  'menu.lab.experiment': '实验管理',
  'menu.lab.data': '实验数据',
  'menu.lab.exception': '异常列表',
  'menu.lab.experimenttest': '实验管理测试',
  'menu.lab.experdatatest': '实验数据测试',
  'menu.report': '报告管理',
  'menu.report.list': '报告列表',
  'menu.report.audit': '报告审核',
  'menu.post': '邮寄管理',
  'menu.post.list': '邮寄列表',
  'menu.finance': '财务管理',
  'menu.finance.ChargesNotes': '收费项目',
  'menu.finance.list': '财务信息',
  'menu.finance.refund': '退款管理',
  'menu.finance.caseReview': '案例审核',
  'menu.authcenter': '系统管理',
  'menu.authcenter.authUser': '用户管理',
  'menu.authcenter.department': '部门管理',
  'menu.authcenter.privilege': '权限管理',
  'menu.authcenter.role': '角色管理',
  'menu.authcenter.entrustList': '委托事项',
  'menu.authcenter.districtList': '行政区划',
  'menu.authcenter.Attachment': '文件管理',
  'menu.authcenter.AttachmentTest': '文件管理测试',
  'menu.authcenter.DictList': '字典列表',
  'menu.authcenter.DictDataList': '字典数据',

  'menu.stat': '数据统计',
  'menu.stat.case': '案件统计汇总',
  ...
  'app.analysis.the-proportion-of-select': '订单查询',
